...
namespace MasterActivator
{
    internal class MActivator
    {
        ...
        MItem cFlaskHP = new MItem("Crystalline Flask", "水晶瓶 HP", "cFlaskHP", 2041, ItemTypeId.HPRegenerator);
        MItem cFlaskMP = new MItem("Crystalline Flask", "水晶瓶 MP", "cFlaskMP", 2041, ItemTypeId.ManaRegenerator);
        #endregion
        ...
        MItem exhaust = new MItem("Exhaust", "虚弱", "SummonerExhaust", 0, ItemTypeId.OffensiveSpell, 650); //summonerexhaust, low, debuff (buffs)
        ...
        MItem smiteAOE = new MItem("SmiteAOE", "紫色-清野", "itemsmiteaoe", 0, ItemTypeId.OffensiveSpell, 500);
        MItem smiteDuel = new MItem("SmiteDuel", "红色-gank", "s5_summonersmiteduel", 0, ItemTypeId.OffensiveSpell, 750);
        MItem smiteQuick = new MItem("SmiteQuick", "灰色-偷野", "s5_summonersmitequick", 0, ItemTypeId.OffensiveSpell, 750);
        MItem smiteGanker = new MItem("SmiteGanker", "蓝色-gank", "s5_summonersmiteplayerganker", 0, ItemTypeId.OffensiveSpell, 750);
        #endregion
        ...
        private void createMenuItem(MItem item, String parent, int defaultValue = 0, bool mana = false, int minManaPct = 0)
        {
            ...
            else
            {
                ...
                if (defaultValue != 0)
                {
                    ...
                    {
                        menu.AddItem(new MenuItem(item.menuVariable + "UseXUnits", "敌人数")).SetValue(new Slider(defaultValue, 1, 5));
                    }
                    else
                    {
        ...
        {
            Config = new Menu("花边-活化剂", "masterActivator", true);
            ...
            Config.AddSubMenu(new Menu("控制", "purify"));
            Config.SubMenu("purify").AddItem(new MenuItem("ccDelay", "延迟(ms)").SetValue(new Slider(0, 0, 2500)));
            ...
            Config.SubMenu("purify").AddItem(new MenuItem("dispellExhaust", "虚弱")).SetValue(false);
            ...
            Config.SubMenu("offensive").SubMenu("menu" + ignite.menuVariable).AddItem(new MenuItem("overIgnite", "只用 点燃")).SetValue(false);
            ...
            // Wards
            Config.AddSubMenu(new Menu("眼位", "wards"));
            var menu = new Menu("Akali W", "menuAkaliW");
            menu.AddItem(new MenuItem("menuAkaliW" + "UseOnPercent", "HP %")).SetValue(new Slider(60, 0, 100));
            menu.AddItem(new MenuItem("menuAkaliW", "启用").SetValue(false));
            menu.AddItem(new MenuItem("akaliWOnCombo", "只连招使用").SetValue(true));

            var menuAkaliWWards = new Menu("眼位", "akaliRWards");
            ...
            Config.SubMenu("combo").AddItem(new MenuItem("comboModeActive", "启用")).SetValue(new KeyBind(32, KeyBindType.Press, true));
            ...
            Config.AddItem(new MenuItem("drawStatus", "显示 状态")).SetValue(true);
