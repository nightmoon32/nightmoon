...
namespace UniversalGankAlerter
{
    internal class Program
    {
        ...
        private void Game_OnGameLoad(EventArgs args)
        {
            ...
            _menu = new Menu("花边-gank提示", "universalgankalerter", true);
            ...
            _sliderLineDuration = new MenuItem("lineduration", "线持续时间(秒)").SetValue(new Slider(10, 0, 20));
            _dangerPing = new MenuItem("dangerping", "危险提示(本地)").SetValue(true);
            _junglerOnly = new MenuItem("jungleronly", "只提示打野").SetValue(false);
