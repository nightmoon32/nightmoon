...
namespace ezEvade
{
    class EvadeTester
    {
        ...
        public EvadeTester(Menu mainMenu)
        {
            ...
            testMenu.AddItem(new MenuItem("TestPath", "测试封包").SetValue(true));
            testMenu.AddItem(new MenuItem("DrawHeroPos", "显示英雄文本").SetValue(true));
        ...
        {
            Game.PrintChat("Ez韬查伩婕㈠寲 by Huabian");
