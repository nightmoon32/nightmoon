...
namespace PerfectWard
{
    internal class PerfectWardTracker
    {
        ...
        public PerfectWardTracker()
        {
            ...
            //Create the menu
            Config = new LeagueSharp.Common.Menu("花边-完美眼位", "PerfectWard", true);
            ...
            Config.SubMenu("Drawing").AddItem(new LeagueSharp.Common.MenuItem("drawDistance", "不显示位置 距离 >")).SetValue(new Slider(2000, 10000, 1));
            Config.SubMenu("Drawing").AddItem(new LeagueSharp.Common.MenuItem("placekey", "插眼 按键").SetValue(new KeyBind("Z".ToCharArray()[0], KeyBindType.Press)));
            Config.SubMenu("Drawing").AddItem(new LeagueSharp.Common.MenuItem("placekeypink", "插真眼 按键").SetValue(new KeyBind("Z".ToCharArray()[0], KeyBindType.Press)));
