...
namespace Support.Plugins
{
    ...
    public class Janna : PluginBase
    {
        ...
        {
            config.AddBool("Misc.E.Tower", "使用 E on Towers", true);

            // build aa menu
            var aa = config.AddSubMenu(new Menu("使用 E on Attacks", "Misc.E.AA.Menu"));
            ...
            // build spell menu
            var dmg = config.AddSubMenu(new Menu("使用 E on Spell", "Misc.E.Spell.Menu"));
